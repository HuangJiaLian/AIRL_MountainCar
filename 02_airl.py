...
@LastEditTime: 2019-11-17 15:25:59
'''
    ...
    with tf.Session() as sess:
        ...
        for episode in range(max_episode):
            ...
            obs, obs_next, acts, path_probs = \
                observations, next_observations, actions, log_probabilities
            expert_obs, expert_obs_next, expert_acts, expert_probs = \
                expert_observations, next_expert_observations, expert_actions, log_expert_probabilities
            ...
            d_rewards = D.get_scores(obs_t=observations)
            ...
            expert_d_rewards = D.get_scores(obs_t=expert_observations)
